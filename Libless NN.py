...
#literally the sum
classification_data = [[1,2,3,],[2, 9, 1], [4, -7, 4], [4, 7, -6],[120,30,400]]
classification_answers = [[6],[12], [1], [5],[450]]

testing_data = [[1,2,3,],[2, 9, 1], [4, -7, 4], [4, 7, -6],[120,30,400]]
testing_answers = [[6],[12], [1], [5],[450]]
...
neural.train(5500, 0.001, classification_data, classification_answers, False)

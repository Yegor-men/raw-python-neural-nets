    ...
    def back_prop(self, inputted_loss_array, learning_rate):
        ...
        for i in range(len(self.weights)):
            for j in range(len(self.weights[0])):
                self.weights[i][j] -= self.weights[i][j]*self.passed_on_loss_array[i]*self.previous_layer_outputs[j] *learning_rate
...
neural.train(100, 0.035, classification_data, classification_answers, False)
